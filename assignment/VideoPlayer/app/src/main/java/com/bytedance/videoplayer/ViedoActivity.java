...
public class ViedoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始的视频uri地址
        String uri_string = "android.resource://"+getPackageName()+"/"+R.raw.e22c;
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.i(TAG, "onDestroy: sdddddddddddddddddddddddddddddddd");
    ...
    protected void onPause() {
        super.onPause();
        pause_flag=true;
        Log.i(TAG, "onPause: ssssssssssssssssssssssssssssssss");
        if(mediaPlayer!=null){
            mediaPlayer.stop();
            mediaPlayer.release();
        }
    ...
    protected void onResume() {
        super.onResume();
        pause_flag=false;
        Log.i(TAG, "onResume: kkkkkkkkkkkkkkkkkkkkkkkk");
    }
}
